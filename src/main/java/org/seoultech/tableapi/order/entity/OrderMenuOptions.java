...
import org.seoultech.tableapi.store.entity.MenuOptions;

@Table(name = "order_menu_options")
@Entity
@Getter
@NoArgsConstructor
public class OrderMenuOptions extends BaseEntity {
    @Id
    ...
    private MenuOptions menuOption; // 이 관계로 MenuOptions와 연관시킴
